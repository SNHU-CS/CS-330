...
1. Translate the camera in the y and x axis, and see whether the visual result is as you expected.
2. Change the field-of-view of the perspective projection. What happens when you make the field-of-view very large? Does the object appear larger or smaller?
3. Move the near plane farther away from the camera. At what point does the cube starts to disappear? Remember that the square is centered at the origin, and that the camera is moved backwards by 3 units.
